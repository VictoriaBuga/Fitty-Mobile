...
public class BackBeginnerActivity extends AppCompatActivity
{
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bs_beginner);
        ...
        Uri uri1 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.bs_beg1);
        ...
        Uri uri2 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.bs_beg2);
        ...
        Uri uri3 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.bs_beg3);
        ...
        Uri uri4 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.bs_beg4);
        ...
        Uri uri5 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.bs_beg5);
        ...
        Uri uri6 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.bs_beg6);
