...
public class AbsMidActivity extends AppCompatActivity
{
    ...
    setContentView(R.layout.activity_abs_mid);
        ...
        Uri uri1 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_mid1);
        ...
        Uri uri2 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_mid2);
        ...
        Uri uri3 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_mid3);
        ...
        Uri uri4 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_mid4);
        ...
        Uri uri5 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_mid5);
        ...
        Uri uri6 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_mid6);
