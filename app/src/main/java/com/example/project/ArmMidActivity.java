...
public class ArmMidActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arm_mid);
        ...
        Uri uri1 = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.arm_mid1);
        ...
        Uri uri2 = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.arm_mid2);
        ...
        Uri uri3 = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.arm_mid3);
        ...
        Uri uri4 = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.arm_mid4);
        ...
        Uri uri5 = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.arm_mid5);
        ...
        Uri uri6 = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.arm_mid6);
