...
public class LegBeginnerActivity extends AppCompatActivity
{
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        Uri uri1 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.legs_beg1);
        ...
        Uri uri2 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.legs_beg2);
        ...
        Uri uri3 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.legs_beg3);
        ...
        Uri uri4 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.legs_beg4);
        ...
        Uri uri5 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.legs_beg5);
        ...
        Uri uri6 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.legs_beg6);
