...
public class AbsBeginnerActivity extends AppCompatActivity
{
    ...
    protected void onCreate (Bundle savedInstanceState) {
       ...
       //video 1
        ...
        Uri uri1 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs1);
        ...
        Uri uri2 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_beginner2);
        ...
        Uri uri3 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_beginner3);
        ...
        Uri uri4 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_beginner4);
        ...
        Uri uri5 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_beginner5);
        ...
        Uri uri6 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.abs_beginner6);
