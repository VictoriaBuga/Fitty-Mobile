...
public class ChestMidActivity extends AppCompatActivity
{
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_mid);
        ...
        Uri uri1 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_mid1);
        ...
        Uri uri2 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_mid2);
        ...
        Uri uri3 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_mid3);
        ...
        Uri uri4 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_mid4);
        ...
        Uri uri5 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_mid5);
        ...
        Uri uri6 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_mid6);
