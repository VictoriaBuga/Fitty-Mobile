...
public class ChestAdvActivity extends AppCompatActivity
{
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        Uri uri1 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_adv1);
        ...
        Uri uri2 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_adv2);
        ...
        Uri uri3 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_adv3);
        ...
        Uri uri4 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_adv4);
        ...
        Uri uri5 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_adv5);
        ...
        Uri uri6 = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.chest_adv6);
